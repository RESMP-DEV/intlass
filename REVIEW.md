# Review guidance for RESMP-DEV/intlass
...
- Review RESMP-DEV/intlass as the source of truth for the behavior and interfaces implemented in this repository.
...
- The target contract is explicit Ampere INT4/INT8 packing, scaling, zero-point, accumulation, wrapper, binding, test, and benchmark behavior; do not leave Blackwell-only FP4/FP8 assumptions in migrated paths.
- CPU-only import checks do not validate extension changes; require sm_80 or sm_86 correctness evidence with deterministic reference comparisons.
